...
<motion.h1 className="text-white text-4xl leading-tight font-bold text-center mb-4 px-4" variants={itemVariants} style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.9)' }}>
  Destrave seu Potencial com o<br className="block" /> 
              ...
              {/* Botão */}
              <motion.div className="flex justify-center mt-10 sm:mt-10 mb-10 px-2 sm:px-4" variants={itemVariants}>
                <button 
className="w-full sm:w-auto min-h-[60px] px-6 py-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all shadow-lg hover:shadow-xl hover:shadow-orange-300/20 flex items-center justify-center group text-lg font-bold max-w-xs sm:max-w-md"
