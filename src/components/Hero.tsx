...
const Hero = () => {
  ...
  return <motion.div className="relative w-full" initial="hidden" animate="visible" variants={containerVariants}>
      <div className="banner-container bg-black relative overflow-hidden min-h-[100vh] sm:min-h-[70vh] md:h-[750px] w-full">
        ...
        <div className="banner-overlay bg-transparent pt-2 sm:pt-16 md:pt-24 w-full min-h-[100vh] sm:min-h-auto">
          <div className="w-full mx-auto px-3 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              ...
              <motion.p className="text-white mt-1 sm:mt-8 text-sm sm:text-xl md:text-2xl font-medium px-2 sm:px-4 leading-relaxed" variants={itemVariants} style={{ textShadow: '1px 1px 3px rgba(0, 0, 0, 0.9)' }}>
              ...
              <motion.div className="flex justify-center mt-3 sm:mt-10 px-2 sm:px-4" variants={itemVariants}>
                <button 
                  className="w-full sm:w-auto min-h-[44px] sm:min-h-[56px] px-4 sm:px-10 py-3 sm:py-5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all shadow-lg hover:shadow-xl hover:shadow-orange-300/20 flex items-center justify-center group text-sm sm:text-xl font-bold max-w-xs sm:max-w-md"
