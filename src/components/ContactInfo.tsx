              ...
              <div className="text-center space-y-6 sm:space-y-8">
                ...
                <div className="bg-gradient-to-r from-blue-900/60 to-dark blue-900/60 p-6 sm:p-8 rounded-lg border-2 border-black-500">
                  <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    <span className="text-lg sm:text-x3 text-white-300 font-medium">Por apenas</span>
                    <span className="text-6xl sm:text-8xl md:text-8xl lg:text-9xl font-black text-green-400 drop-shadow-lg">R$17,99</span>
                  </div>
