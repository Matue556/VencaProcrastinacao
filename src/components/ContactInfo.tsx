    ...
    <section id="offer" className="bg-gradient-to-br from-gray-900 to-black text-white py-6 sm:py-16 md:py-20 relative overflow-hidden border-t-4 border-orange-500">
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-red-800/80 backdrop-blur-sm border-2 border-dark blue-500 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-8 md:p-10 relative overflow-hidden">
            {/* Gradiente sutil de fundo */}
            <div className="absolute inset-0 bg-gradient-to-br from-redk-900/20 to-red-900/30 rounded-xl sm:rounded-2xl"></div>
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6 md:space-y-8">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-dark blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </Button>
