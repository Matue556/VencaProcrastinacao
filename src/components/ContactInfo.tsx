          ...
          <div className="bg-red-800/80 backdrop-blur-sm border-2 border-dark blue-500 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <Button
                ...
                className="w-full py-4 sm:py-6 md:py-8 lg:py-10 text-lg sm:text-xl md:text-2xl bg-gradient-to-r from-black -500 to-black-500 hover:from-black-600 hover:to-black-600 text-white rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 font-royal blue relative overflow-hidden group min-h-[60px] sm:min-h-[80px] border-3 border-yellow-400 transform hover:scale-105"
              >
