...
const CountdownTimer = () => {
  ...
  return (
    <motion.div 
      className="text-center py-4 px-6 mx-4 sm:mx-6 mb-6 bg-gradient-to-r from-dark blue-900/90 to-blue-800/90 backdrop-blur-sm border border-dark blue-500/30 rounded-xl shadow-2xl"
